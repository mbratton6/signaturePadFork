var content = (penColor, backgroundColor, dataURL) => `
  ...
  var showSignaturePad = function (signaturePadCanvas, bodyWidth, bodyHeight) {
    ...
    var finishedStroke = function(base64DataUrl, wasCleared) {
    if(wasCleared == true){
    executeNativeFunction('finishedStroke', {base64DataUrl: "cleared"});
    }
    ...
    var enableSignaturePadFunctionality = function () {
      var signaturePad = new SignaturePad(signaturePadCanvas, {
        ...
        onEnd: function(wasCleared) { finishedStroke(signaturePad.toDataURL(), wasCleared); }
      });
